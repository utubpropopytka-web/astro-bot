...
{{
  ...
  "sections": [
    {{"title": "Астрологическая основа", "text": "3-4 предложения: какие планеты и знаки формируют этот паттерн конкретно у этого человека, включая одно значимое сочетание двух положений"}},
    {{"title": "Как это проявляется", "text": "3-4 предложения: узнаваемые ситуации из реальной жизни — и сильная сторона, и теневая (где это мешает или какой ценой достаётся)"}},
    {{"title": "Практический совет", "text": "2-3 предложения: что конкретно делать с этим знанием прямо сейчас — действие, а не пожелание"}}
  ]
}}
