...
{{
  ...
  "sections": [
    ...
    {{"icon": "♀️", "title": "Любовь и отношения", "planet": "Венера", "text": "2-3 предложения — как проявляет себя в любви"}},
    {{"icon": "♂️", "title": "Энергия и действия", "planet": "Марс", "text": "2-3 предложения — воля, инициатива, решения"}},
    {{"icon": "♃", "title": "Рост и потенциал", "planet": "Юпитер", "text": "2-3 предложения — удача и широта взглядов"}},
    {{"icon": "♄", "title": "Уроки и дисциплина", "planet": "Сатурн", "text": "2-3 предложения — сложности и зоны роста"}},
    {{"icon": "✦", "title": "Главный совет", "planet": "", "text": "1-2 предложения — ключевое послание для этого человека"}}
  ]
}}

Пиши тепло, на «ты». Только JSON."""
        ...
        if analysis_json:
            ...
            logger.warning("Analysis JSON parse failed, returning raw text")
