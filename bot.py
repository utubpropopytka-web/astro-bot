...
ФОРМАТ ТЕКСТА СЕКЦИЙ: каждое поле "text" — это 2-3 КОРОТКИХ абзаца по 1-2 предложения. Абзацы разделяй символом \n (перенос строки внутри JSON-строки). Никаких сплошных полотен текста — каждый абзац несёт одну мысль.
}}
...
4. Каждое поле "text" — 2-3 КОРОТКИХ абзаца по 1-2 предложения, разделённые символом \n. Никаких сплошных полотен.
...
5. Каждое поле "text" — 2-3 КОРОТКИХ абзаца по 1-2 предложения, разделённые символом \n.
